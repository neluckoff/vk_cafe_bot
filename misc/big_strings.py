admin_memo = f'КОМАНДЫ АДМИНИСТРАТОРОВ (МЕНЕДЖЕРОВ)\n\n' \
             ...
             f'[11] Обращения - посмотреть список всех необработанных обращений\n' \
             f'[12] Обращение NUM - посмотреть информацию об обращении под номером NUM\n\n' \
             ...
             f'[2] Снять ID (Снять админа ID) - забрать доступ ко всем командам администрирования у пользователя\n' \
             f'[3] Рассылка - отправить всем пользователям сообщние с текстом акции, нового поста и т.д.\n' \
             f'[4] Скачать таблицу заказов - создать таблицу со всеми заказами\n' \
             f'[5] Скачать таблицу пользователей - создать таблицу со всеми зарегестрированными пользователями\n' \
...
all_commands = ['Меню', '/menu', '👈🏻 Назад', 'Начать', 'Ку', 'Привет' '/start', 'О нас', 'Личный кабинет',
                'Мой телефон', 'Мой адрес', 'Количество заказов', 'Указать номер телефона', 'Указать свой адрес',
                'Связаться', 'Вопрос', 'Помощь', 'Сделать заказ', 'Начать работу']
